...
import { View, ActivityIndicator, StyleSheet, BackHandler, Platform, FlatList, Text, RefreshControl } from "react-native";
            ...
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    <View style={styles.scorelist}>
                      <Text style={styles.name}>{item.name}</Text><Text style={styles.score}>{item.score}</Text>
                    </View>
                  }
                />
            </View>
